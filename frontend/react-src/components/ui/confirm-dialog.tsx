  ...
  return (
    ...
    >
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="fixed left-1/2 top-1/2 z-[81] w-[min(92vw,28rem)] -translate-x-1/2 -translate-y-1/2 rounded-sm border border-[var(--border)] bg-[var(--surface)] p-5">
          <AlertDialog.Title className="text-lg font-semibold text-[var(--text)]">
            {confirm.title || 'Confirm'}
          </AlertDialog.Title>
          <AlertDialog.Description className="mt-2 text-sm leading-6 text-[var(--text-2)]">
            {confirm.message}

...
const HomePage = lazy(async () => import('@/pages/home-page').then((module) => ({ default: module.HomePage })))
...
const ContinuousResultPage = lazy(async () =>
  import('@/pages/continuous-result-page').then((module) => ({ default: module.ContinuousResultPage })),
)
          ...
          <AppFrame>
            <Suspense fallback={<div className="py-16 text-center text-sm text-slate-500">Loading…</div>}>
              <Routes>
                ...
                <Route path="/results/continuous/:id" element={<ContinuousResultPage />} />
                <Route path="*" element={<Navigate to="/test" replace />} />
              </Routes>
            </Suspense>
          </AppFrame>
